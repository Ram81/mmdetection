...
# ]
classes = ["background"] + sorted(json.loads(open("data/hm3d_semantic/hm3d_objects_train.json").read()))
...
data = dict(
    ...
    train=dict(
        img_prefix='data/hm3d_semantic/segmentation_coco_full/train/',
        classes=classes,
        ann_file='data/hm3d_semantic/segmentation_coco_full/annotations/hm3d_train_deduped.json'),
    val=dict(
        img_prefix='data/hm3d_semantic/segmentation_coco_full/val/',
        classes=classes,
        ann_file='data/hm3d_semantic/segmentation_coco_full/annotations/hm3d_val_deduped.json'),
    test=dict(
        img_prefix='data/hm3d_semantic/segmentation_coco_full/val/',
        classes=classes,
        ann_file='data/hm3d_semantic/segmentation_coco_full/annotations/hm3d_val_deduped.json'))
